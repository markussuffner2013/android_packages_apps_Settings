...
public class PACLogoActivity extends Activity {
    ...
    private View makeView() {
        ...
        String pacVersion = SystemProperties.get("ro.probam.version");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContent.setImageResource(R.drawable.codexclogo);
            ...
            public boolean onLongClick(View v) {
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .setClassName("com.android.settings","com.android.settings.probam.PACCircus"));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("ProBamLogoActivity", "Couldn't find a circus of PAC's.");
                }
                finish();
                return true;
            }
