...
public class PACCircus extends Activity {
    ...
    private static class Board extends FrameLayout
    {
        ...
        static int PACS[] = {
          R.drawable.probam_yellow,
          R.drawable.probam_green,
          R.drawable.probam_pink,
          R.drawable.probam_blue
        };
                ...
                public void onTimeUpdate(TimeAnimator animation, long totalTime, long deltaTime) {
                    if (DEBUG) {
                        for (int i=0; i<getChildCount(); i++) {
                            android.util.Log.d("ProbamCircus", "probam " + i + ": " + getChildAt(i));
                        }
                    }
